    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h2 class="m-0">List Supplier</h2>
                <div class="w-auto ms-2 float-end">
                    <button type="button" class="btn btn-rounded btn-success" onclick="addForm('{{route('supplier.store')}}')">
...
@push('scripts')
    <script>
        ...
        function addForm(url){
            $('#addModal').modal('show');
            $('#addModal .modal-title').text('Tambah Supplier');
        ...
        function editForm(url){
            $('#addModal').modal('show');
            $('#addModal .modal-title').text('Edit Supplier');
        ...
        function cetakMember(url){
            if($('input:checked').length < 1) {
                ...
                $('.form-supplier').attr('target', '_blank').attr('action', url).submit();
